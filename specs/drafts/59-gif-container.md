...
7. Add fixtures under `fixtures/minimal/` (`happy.gif`, `animated.gif`, `xmp.gif`) constructed by a small helper or written as inline byte vectors in the fixture build script pattern used elsewhere; commit binary fixtures.
